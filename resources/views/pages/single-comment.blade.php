        ...
        @forelse ($comments as $comment)
            <div class="py-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    {{-- CARD EDIT DELETELE BUTTON Start OPTION --}}
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    tabindex="-1">
                                    <a
                                    href="{{ route('showComment',$comment->uuid) }}"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                    role="menuitem"
                                    tabindex="-1"
                                    id="user-menu-item-0"
                                    ...
                                    >
                                    <a
                                    href="{{ route('destroy',$comment->uuid) }}"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                    role="menuitem"
                                    tabindex="-1"
                                    id="user-menu-item-1"
                  ...
                  @endif
                  {{-- CARD EDIT DELETELE BUTTON END OPTION --}}
                </div>
                </header>
                <!-- Content -->
                <div class="py-4 text-gray-700 font-normal">
